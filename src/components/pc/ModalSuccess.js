...
const ModalSuccess = ({ isOpen, orderData, customerName, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] overflow-hidden">
      ...
      <div className={`relative z-10 h-full flex items-center justify-center p-8 transition-all duration-500 delay-300 ${showAnimation ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
        }`}>
